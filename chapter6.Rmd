...
Here we can see results of ANOVA for two aforementioned models. Here we can see that due to Chi^2 test, there is significant difference between these two models.
...
Here again ANOVA for two latest models.  Due to Chi^2 test, there is significant difference between these two models.
