...
#### Factor variable Crime classified by Colours (1 = low, 4 = high)

How do the plots differ? Are there any similarities?  Data points are of course in same positions. Grouping differs slightly in main group if colours are coded either by crime or by cluster. In the separate group one cluster and high-crime are majority. If colours are coded by crime, particularly the high-crime is better gathered to on group.
...
#### Clusters classified by Colours 
